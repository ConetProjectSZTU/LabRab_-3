def count_letters(text):
  ...
  Args:
    text: Текст, в котором нужно подсчитать буквы.

  Returns:
    Словарь, где ключи - буквы нижнего регистра, а значения - их количество.
  """
  letter_counts = {}
  for char in text:
    if char.isalpha():
...
def calculate_frequency(letter_counts):
  ...
  Args:
    letter_counts: Словарь с количеством каждой буквы.
